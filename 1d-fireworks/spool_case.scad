...
module spool_led_protection_bulge_3d(height=spool_case_strip_height) {
...
module spool_case_lower() {
    ...
    difference() {
        ...
        translate([-led_strip_width / 2, -1, -led_strip_height / 2])
            cube([led_strip_width, led_strip_clutch_length + 2, led_strip_height]);
...
module spool_case_upper() {
    ...
    rotate([-90,0,0])
        difference() {
            spool_cut(-spool_case_radius + led_strip_clutch_length) spool_3d();
            translate([0,-spool_cutter.y/2,0])
                cube(spool_cutter, center=true);
        } 
